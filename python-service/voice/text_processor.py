...
NATURAL_PHRASES = {
    ...
    'que tal': 'que tal',
    # Chilean colloquial phrases
    'como estai': 'como estas',
    'que onda': 'que onda',
    'cachai': 'cachai',
    'ya po': 'ya po',
    'dale': 'dale',
    ...
    # Common phrases Luna uses
    'espero que': 'espero que',
    'me alegro': 'me alegro',
    'no se preocupe': 'no se preocupe',
    'con gusto': 'con gusto',
    'para servirte': 'para servirte',
...
# NOTE: Keys are sorted by length (longest first) to avoid partial matches.
# Duplicates removed in session 42 cleanup.
ASR_RESPELLING = {
    # ── User nicknames ──────────────────────────────────────────
    'de kov': 'Dekov',
    'the kov': 'Dekov',
    ...
    # ── MiMo model names ───────────────────────────────────────
    'mimo v dos punto cinco': 'MiMo v2.5',
    'mimo v2 punto 5': 'MiMo v2.5',
    'mimo version dos punto cinco': 'MiMo v2.5',
    ...
    # ── Tech terms — ASR consistently misrecognizes ─────────────
    ...
    # ── MiMo Desktop / MiMo integration (session 42) ───────────
    'mimo desktop': 'MiMo Desktop',
    'mi mo desktop': 'MiMo Desktop',
    'mimo d e s k t o p': 'MiMo Desktop',
    ...
    # ── Chilean place names / proper nouns (session 42) ─────────
    'santiago': 'Santiago',
    ...
    # ── App / tool names Nicolas uses (session 42) ──────────────
    ...
    'iron mace': 'IRONMACE',
    'gadget bridge': 'Gadgetbridge',
    'parsec': 'Parsec',
    'team viewer': 'TeamViewer',
    'file zilla': 'FileZilla',
    'notepad plus plus': 'Notepad++',
    'notepad mas mas': 'Notepad++',
    'rain meter': 'Rainmeter',
    'obs studio': 'OBS Studio',
    'o b s': 'OBS',
    'cheat engine': 'Cheat Engine',
    'osu ai': 'OsuAI',

    # ── Anime / cultural references Nicolas uses ────────────────
    'sword art online': 'Sword Art Online',
    'sao': 'SAO',
    'dan machi': 'DanMachi',
    'danmachi': 'DanMachi',
    'hololive': 'Hololive',
    'hoshimachi': 'Hoshimachi',
    'oozora': 'Oozora',
    'suisei': 'Suisei',
    'subaru': 'Subaru',
